...
function Staff(props: StaffProps) {
  ...
  const [respostas, setRespostas] = useState({
    ...
    'Gestão eficiente do time e delegação de tarefas': { 'comentar':'', 'nota':0},
    'Capacidade de solucionar conflitos internos': { 'comentar':'', 'nota':0},
    'Organização e planejamento estratégico': { 'comentar':'', 'nota':0},
    'Capacidade de inovação e melhorias nos processos': { 'comentar': '', 'nota': 0 }
  });
    ...
    return (
        <div>
          ...
          <section>
            ...
            <p>
              Avalie seu próprio desempenho durante os últimos meses do,utilizando a escala abaixo:
            </p>
              <ul>
          ...
          <p>
            Avaliação do Lider (coordenador)
          </p>

          <Table perguntas = {perguntas2} resposta={respostas} onRespostaChange={handleRespostaChange}/>


          <section>
            <Input id="positive-points" label="Pontos positivos:" setValue={setPositivos} />

          </section>
          <section>
            <Input id="negative-points" label="Pontos a melhorar:" setValue={setNegativos} />
          </section>
